...
void main() {
  group('Automatic Context Detection Tests', () {
    testWidgets('Context indicator shows placeholder without context', (tester) async {
    ...
    test('VoiceStateNotifier has context methods', () {
      final notifier = VoiceStateNotifier();

      expect(notifier.state.detectedContext, isNull);

      final context = ApplicationContext(
        contextId: 'method-test',
      ...
      expect(notifier.state.detectedContext?.applicationName, 'Discord');
